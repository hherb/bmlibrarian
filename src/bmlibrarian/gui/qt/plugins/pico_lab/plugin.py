...
Provides an interactive interface for experimenting with PICOAgent
and extracting Population, Intervention, Comparison, and Outcome components
...
class PICOLabPlugin(BaseTabPlugin):
    ...
    def get_metadata(self) -> TabPluginMetadata:
        ...
        return TabPluginMetadata(
            ...
            description="Interactive laboratory for extracting Population, Intervention, Comparison, and Outcome components from research papers",
            version="1.0.0",
            icon="experiment",
            requires=[]
        )
    ...
    def on_tab_activated(self):
        ...
        self.status_changed.emit("PICO Lab activated - Ready to extract PICO components")
