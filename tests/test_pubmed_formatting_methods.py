"""
Unit tests for PubMed Bulk Importer formatting methods.

Tests the new Markdown formatting capabilities by directly testing the methods:
- _get_element_text_with_formatting(): Inline formatting conversion
- _format_abstract_markdown(): Structured abstract formatting

These tests use a simple test class that mimics the bulk importer's methods
...
class PubMedFormatterTestable:
    """
    Testable version of PubMed formatting methods.

    This class contains only the formatting methods we want to test,
    copied directly from PubMedBulkImporter, without database dependencies.
    """
...
class TestTextFormattingExtraction:
    ...
    def formatter(self):
        ...
        return PubMedFormatterTestable()

    def test_simple_text_no_formatting(self, formatter):
        """Test extraction of plain text without any formatting."""
        xml_str = '<title>Simple text without formatting</title>'
        elem = ET.fromstring(xml_str)
        result = formatter._get_element_text_with_formatting(elem)
        assert result == 'Simple text without formatting'

    def test_bold_formatting(self, formatter):
    ...
    def test_italic_formatting(self, formatter):
    ...
    def test_superscript_formatting(self, formatter):
    ...
    def test_subscript_formatting(self, formatter):
    ...
    def test_underline_formatting(self, formatter):
    ...
    def test_nested_formatting(self, formatter):
    ...
    def test_multiple_formatting_elements(self, formatter):
    ...
    def test_unknown_tag(self, formatter):
    ...
    def test_empty_element(self, formatter):
        """Test handling of empty elements."""
        result = formatter._get_element_text_with_formatting(None)
        assert result == ''

    def test_element_with_tail_text(self, formatter):
    ...
    def test_scientific_notation_example(self, formatter):
...
class TestAbstractMarkdownFormatting:
    ...
    def test_unstructured_abstract(self, formatter):
        ...
        elem = ET.fromstring(xml_str)
        result = formatter._format_abstract_markdown(elem)
        assert result == 'This is a simple unstructured abstract without section labels.'

    def test_structured_abstract_with_label(self, formatter):
    ...
    def test_structured_abstract_with_nlmcategory(self, formatter):
    ...
    def test_nlmcategory_unassigned_filtered(self, formatter):
    ...
    def test_label_preferred_over_nlmcategory(self, formatter):
    ...
    def test_abstract_with_inline_formatting(self, formatter):
    ...
    def test_mixed_labeled_unlabeled_sections(self, formatter):
    ...
    def test_empty_abstract(self, formatter):
        """Test handling of empty abstract."""
        result = formatter._format_abstract_markdown(None)
        assert result == ''

    def test_abstract_without_abstracttext_elements(self, formatter):
    ...
    def test_paragraph_breaks_between_sections(self, formatter):
    ...
    def test_real_world_structured_abstract(self, formatter):
